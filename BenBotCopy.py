...
TOKEN = "Insert Token Here" #Removed Token for privacy concern's
...
async def on_ready():
    ...
    await client.get_channel("Insert Channel Here").send("Ben...")
    await client.get_channel("Insert Channel Here").send(PICKUP)
